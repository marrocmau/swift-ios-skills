...
6. **ios-security** — Credentials, encryption, Face ID
...
7. **app-store-review** — Submission checklist
...
8. **swiftui-forms** — User input patterns
   - Form validation
...
9. **image-handling** — Photos, camera, display
...
10. **sentry-setup** — Crash reporting & monitoring
...
11. **revenuecat-subscription** — Monetization
...
12. **fastlane-automation** — Screenshot + submission
...
13. **metadata-localization** — Multi-language support
...
14. **push-notifications** — Engagement
...
15. **analytics-integration** — Product usage tracking
...
16. **aso-keyword-research** — App Store Optimization
...
17. **in-app-review-prompt** — Ratings
...
18. **deep-linking** — Social sharing
...
19. **swiftui-animations** — Polish & feel
    - Spring animations
    - PhaseAnimator
    - Gesture feedback
    - Micro-interactions
...
20. **widgetkit-homescreen** — Home Screen widgets
    - WidgetKit setup
    - Home screen widgets
...
21. **live-activities** — Dynamic Island
    - ActivityKit setup
...
22. **on-device-ai** — Apple Intelligence
...
23. **app-intents** — Siri integration
    - AppIntents protocol
    - Siri voice commands
    - Shortcuts support
...
24. **accessibility-advanced** — A11y polish
...
25. **storekit2-advanced** — In-app purchase advanced
...
| 7 | app-store-review | 1 | ⭐⭐⭐⭐⭐ | 1-2h | ~350 | 🔲 |
| 8 | swiftui-forms | 1 | ⭐⭐⭐⭐ | 2h | ~450 | 🔲 |
| 9 | image-handling | 1 | ⭐⭐⭐⭐ | 2-3h | ~400 | 🔲 |
| 10 | sentry-setup | 2 | ⭐⭐⭐⭐⭐ | 1-2h | ~350 | 🔲 |
| 11 | revenuecat-subscription | 2 | ⭐⭐⭐⭐⭐ | 3-4h | ~500 | 🔲 |
| 12 | fastlane-automation | 2 | ⭐⭐⭐⭐ | 2-3h | ~400 | 🔲 |
| 13 | metadata-localization | 2 | ⭐⭐⭐⭐ | 2-3h | ~400 | 🔲 |
| 14 | push-notifications | 2 | ⭐⭐⭐ | 2h | ~380 | 🔲 |
| 15 | analytics-integration | 2 | ⭐⭐⭐⭐ | 2-3h | ~420 | 🔲 |
| 16 | aso-keyword-research | 3 | ⭐⭐⭐⭐⭐ | 2-3h | ~380 | 🔲 |
| 17 | in-app-review-prompt | 3 | ⭐⭐⭐⭐ | 1h | ~280 | 🔲 |
| 18 | deep-linking | 3 | ⭐⭐⭐⭐ | 2-3h | ~400 | 🔲 |
...
**Should-have (do if app uses them):**
3. swiftui-forms (if forms)
4. image-handling (if photos)
5. revenuecat-subscription (if monetized)

**Nice-to-have (do later):**
6. fastlane-automation (after 1st submission)
7. metadata-localization (app 2+)
8. push-notifications (after launch)
9. analytics-integration (week 2+)
